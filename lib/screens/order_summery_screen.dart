...
import 'package:kangmas_app/models/renovate_services_model.dart';
import 'package:kangmas_app/screens/payment_screen.dart';
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => PaymentScreen(
                            weekday: widget.weekday == "" ? "Rabu" : widget.weekday,
                            list: widget.list,
                          ),
                        ),
                      );
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Space(2),
                                    Text("di", style: TextStyle(color: appData.isDark ? cardTextDark : cardText, fontSize: 8)),
                                    Space(2),
                                    Text(
                                      widget.weekday != "" ? widget.weekday : "Rabu",
                      ...
                      children: [
                        IntrinsicHeight(
                          child: Row(
                            children: [
                              Text(
                                widget.area != "" ? "${widget.area} Sqft" : "Detail Masalah",
                                style: TextStyle(
                        ...
                        Text("Rp.${widget.list[index].price}", style: TextStyle(fontWeight: FontWeight.w900, fontSize: 18)),
                      ],
                    ),
                  ],
                ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Space(4),
                          Text(
                            "Jalan Kenangan Yang Pernah Ada",
                            textAlign: TextAlign.start,
                            style: TextStyle(
                              color: appData.isDark ? cardTextDark : cardText,
                              fontSize: 14,
                    ...
                    ExpansionTile(
                      ...
                      children: [
                        ListTile(
                          ...
                          trailing: Text("Rp.${widget.list[0].price}", textAlign: TextAlign.start, style: TextStyle(fontSize: 14)),
                        ),
                        ListTile(
                          title: Text(
                            "PPN",
                          ...
                          trailing: Text("Rp.40", textAlign: TextAlign.start, style: TextStyle(fontSize: 14)),
                        ),
                        ListTile(
                          title: Text(
                            "Diskon Kupon",
                          ...
                          trailing: Text("- Rp.160", textAlign: TextAlign.start, style: TextStyle(fontSize: 14)),
                        ),
                      ],
                    ),
