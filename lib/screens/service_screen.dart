...
import 'package:kangmas_app/components/apartment_size_component.dart';
...
import 'package:kangmas_app/utils/date.dart' as date;
          ...
          SliverToBoxAdapter(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Text("Pilih Jadwal", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
                  Space(16),
                  ApartmentSizeComponent(),
                  Space(16),
                  Text("Deskripsi Masalah", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
                  Space(16),
                  TextField(
                  ...
                  // ),
                  Space(16),
                  Text("Pilih Tanggal", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
                  Space(16),
                  Row(
                  ...
                  Space(16),
                  Text("Pilih Waktu Mulai", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
                  Space(8),
                  Text('Waktu Pengerjaan: ${_time.format(context)}'),
                  Space(8),
