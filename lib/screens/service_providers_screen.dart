...
import 'package:kangmas_app/screens/provider_detail_screen.dart';
                                ...
                                Column(
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        Text(
                                          "Rp.${serviceProviders[widget.index].serviceProviders[index].perHourPrice}",
                                          style: TextStyle(fontWeight: FontWeight.w900, fontSize: 20),
                                        ),
                                        Text(
                                          "/jam ",
                                    ...
                                    Space(8),
                                    ElevatedButton(
                                      child: Text("Pesan", textAlign: TextAlign.center, style: TextStyle(color: Colors.white)),
                                      onPressed: () {
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
