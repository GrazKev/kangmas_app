...
import 'package:kangmas_app/components/payment_container.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            PaymentContainer(title: "Kartu Kredit dan Debit", icon: Icons.credit_card),
            Space(16),
            ...
            Space(16),
            PaymentContainer(title: "E-Wallets", icon: Icons.wallet, isUpi: true,),
            Space(16),
          ],
        ),
      ),
